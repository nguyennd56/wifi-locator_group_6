...
public class Label extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		textBox= (EditText)findViewById(R.id.place_name_edit);
	...
	public void onClickSave(View view){
		String locationName=textBox.getText().toString();
		current_Location= new Location("unknow","unknow","unknow","unknow",locationName,currentListSignals);
		try{
			//---SD Card Storage---
